...
?>
    ...
    <fieldset>
    	<p style="align:center;" class="intro">¿Te cuesta ver el tamaño de la letra? Pulsa aquí para aumentar el tamaño de la fuente.</p>
			<input style="align:center;" name="botonModificar" type="button" value="modificar Tamaño" onclick="Tamano()"/>	
   	</fieldset>        
    <!--/AREA BIENVENIDA-->
    <!--AREA SLIDER-->
