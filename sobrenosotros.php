        ...
        <div class="gray_bg">
            <div class="container">
                <div class="row welcome_inner">
                    <div class="span12">
                        <h1><span class="colored">///</span> Sobre nuestra empresa</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container inner_content">
            <section>
                <div class="row">
                    ...
                    <div class="span4">
                        <iframe src="http://player.vimeo.com/video/35330925?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" height="250" width="100%" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                    </div>
                </div>
            </section>
            ...
            <h2>Julen</h2>
                <div class="row">
                    ...
                    <div class="span4">
                        ...
                        <hr class="dash">
                        <div class="intro">
                            <p style="margin-bottom:10px;"><em>Antes trabajaba desarrollando aplicaciones para linux, pero como a los usuarios de linux no les gusta pagar por los productos que adquieren, su empresa se fué a la quiebra, eclipsada por productos de mucha menor calidad, pero gratis.<br><br>Julen procede de Colombia, donde tuvo que  cambiar dos bicicletas por un ordenador con una caja de cartón como torre, se inició en la informática con un portatil "extraviado".</em></p>
                        </div>
                        <hr class="dash">
                        <div class="row">
                            <div class="span2">
                     ...
                     <div class="span4">
                        ...
                        <hr class="dash">
                        <div class="intro">
                            <p style="margin-bottom:10px;"><em>Su mayor punto fuerte es el diseño web, aunque por alguna extraña razón aún usa boli y papel, se ve que o vive en la prehistoria o odia al amazonas.</em></p>
                        </div>
                        <hr class="dash">
                        <div class="well">
                            <h6>Diseño Web</h6>
            ...
            <div class="row">
                <div class="span12">
                    <hr style="margin-bottom:0px; margin-top:40px;">
                </div>
            </div>
            ...
            <section>
                <div class="row portfolio">
                    <div class="span12">
                        <h2><span class="colored"><strong>///</strong></span> <span class="undercolored"><a href="#">Proyectos</a></span> recientes</h2>
                        <hr class="dash">
                        <div class="intro">
            ...
            <div class="container">
                <div class="row">
                    <div class="span3 header">
                        <h5><span class="colored">///</span><a href="https://twitter.com/j3a_design"></h5>
